...
const Layout = ({ children }) => {
  const navItems = ["ABOUT", "RESUME", "PROJECTS", "SKILLS", "CONTACT"];

  
  return (
    <main className="flex min-h-screen flex-col bg-blue-50">
      <header className="flex items-center justify-between bg-white py-2 px-4 border-b border-gray-200 lg:py-2">
        <h1 className="text-black text-sm lg:text-xl font-semibold tracking-wide">
      ...
      <div className="max-w-7xl mx-auto p-8 mt-6 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3 pl-0 md:pl-8 border-l md:border-l border-gray-300">
          <div className="w-full bg-white rounded-md px-7 py-6">
            {children}
          </div>
        </div>
      </div>
